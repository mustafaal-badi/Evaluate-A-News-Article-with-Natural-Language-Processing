...
.container {
  ...
  margin: 0 auto;
  padding: 20px;
}`, "",{"version":3,"sources":["webpack://./src/client/styles/base.scss"],"names":[],"mappings":"AACA;EACI,8BAAA;EACA,yBAAA;EACA,cAAA;AAAJ;;AAGA;EACI,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,aAAA;AAAJ;;AAGA;EACI,gBAAA;EACA,iBAAA;AAAJ;;AAGE;EACE,gBAAA;EACA,yBAAA;EACA,mBAAA;EACA,2CAAA;EACA,cAAA;EACA,aAAA;AAAJ","sourcesContent":["\nbody {\n    font-family: Arial, sans-serif;\n    background-color: #f8eccc;\n    color: #000000;\n}\n\nmain {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    height:  100vh;\n}\n\nsection {\n    max-width: 800px;\n    margin: 50px auto;\n}\n \n  .container {\n    max-width: 600px;\n    background-color: #faf9fa;\n    border-radius: 10px;\n    box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);\n    margin: 0 auto;\n    padding: 20px;\n  }\n  "],"sourceRoot":""}]);
// Exports
...
.social a:hover {
  color: #f8f7f6;
}`, "",{"version":3,"sources":["webpack://./src/client/styles/footer.scss"],"names":[],"mappings":"AAAA;EACI,yBAAA;EACA,WAAA;EACA,aAAA;EACA,kBAAA;AACJ;;AACE;EACE,gBAAA;AAEJ;;AACA;EACI,cAAA;EACA,aAAA;EACA,WAAA;EACA,gCAAA;AAEJ;;AACA;EACI,cAAA;AAEJ","sourcesContent":["footer {\r\n    background-color: #3498db;\r\n    color: #fff;\r\n    padding: 20px;\r\n    text-align: center;\r\n  }\r\n  .social {\r\n    margin-top: 20px;\r\n}\r\n\r\n.social a {\r\n    margin: 0 10px;\r\n    padding: 10px;\r\n    color: #000;\r\n    transition: all 0.3s ease-in-out;\r\n}\r\n\r\n.social a:hover {\r\n    color: #f8f7f6;\r\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
section div[id^=score_tag] {
  font-weight: 5px;
  text-transform: capitalize;
}
section div[id^=score_tag].p {
  color: green;
}
section div[id^=score_tag].N {
  color: red;
}
section div[id^=score_tag].NEU {
  color: gray;
}
...
#error {
  ...
  border-radius: 10px;
  padding: 20px 10px;
}`, "",{"version":3,"sources":["webpack://./src/client/styles/form.scss"],"names":[],"mappings":"AACA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;AAAF;AACE;EACE,mBAAA;EACA,iBAAA;AACJ;AAEE;EACE,aAAA;EACA,mBAAA;EACA,YAAA;EACA,kBAAA;EACA,oCAAA;AAAJ;AAGE;EACE,kBAAA;EACA,YAAA;EACA,kBAAA;EACA,yBAAA;EACA,YAAA;EACA,iBAAA;EACA,eAAA;EACA,gCAAA;AADJ;AAGI;EACE,yBAAA;AADN;;AAMA;EACE,mBAAA;AAHF;AAKE;EACE,cAAA;EACA,mBAAA;EACA,iBAAA;AAHJ;AAME;EACE,gBAAA;EACA,0BAAA;AAJJ;AAMI;EACE,YAAA;AAJN;AAOI;EACE,UAAA;AALN;AAQI;EACE,WAAA;AANN;;AAWA;EACE,2BAAA;EACA,mBAAA;EACA,kBAAA;AARF","sourcesContent":["\nform {\n  display: flex;\n  flex-direction: column;\n  margin-bottom: 20px;\n  label {\n    margin-bottom: 10px;\n    font-weight: bold;\n  }\n\n  input[type=\"text\"] {\n    padding: 10px;\n    margin-bottom: 20px;\n    border: none;\n    border-radius: 5px;\n    box-shadow: 0px 0px 5px rgba(0, 0, 0, 1.0);\n  }\n\n  .btn-submit {\n    padding: 10px 20px;\n    border: none;\n    border-radius: 5px;\n    background-color: #007bff;\n    color: white;\n    font-weight: bold;\n    cursor: pointer;\n    transition: all 0.2s ease-in-out;\n\n    &:hover {\n      background-color: darken($color: #2ecc71, $amount: 10%);\n    }\n  }\n}\n\nsection {\n  margin-bottom: 20px;\n\n  strong {\n    display: block;\n    margin-bottom: 10px;\n    font-weight: bold;\n  }\n\n  div[id^=\"score_tag\"]{\n    font-weight: 5px;\n    text-transform: capitalize;\n\n    &.p {\n      color: green;\n    }\n\n    &.N {\n      color: red;\n    }\n\n    &.NEU {\n      color: gray;\n    }\n  }\n}\n\n#error {\n  background-color: orangered;\n  border-radius: 10px;\n  padding: 20px 10px;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
___CSS_LOADER_EXPORT___.push([module.id, `header {
  ...
  color: #fff;
  text-align: center;
}`, "",{"version":3,"sources":["webpack://./src/client/styles/header.scss"],"names":[],"mappings":"AAAA;EACI,aAAA;EACA,uBAAA;EACA,kBAAA;EACA,yBAAA;EACA,WAAA;EACA,kBAAA;AACJ","sourcesContent":["header {\n    display: flex;\n    justify-content: center;\n    padding: 10px 40px;\n    background-color: #3498db;\n    color: #fff;\n    text-align: center;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
} */`, "",{"version":3,"sources":["webpack://./src/client/styles/resets.scss"],"names":[],"mappings":"AAAA;;;CAAA;AAKA;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;GAAA","sourcesContent":["/* http://meyerweb.com/eric/tools/css/reset/\n   v2.0 | 20110126\n   License: none (public domain)\n*/\n\n/* {\n     box-sizing: border-box;\n}\n\nhtml, body, div, span, applet, object, iframe,\nh1, h2, h3, h4, h5, h6, p, blockquote, pre,\na, abbr, acronym, address, big, cite, code,\ndel, dfn, em, img, ins, kbd, q, s, samp,\nsmall, strike, strong, sub, sup, tt, var,\nb, u, i, center,\ndl, dt, dd, ol, ul, li,\nfieldset, form, label, legend,\ntable, caption, tbody, tfoot, thead, tr, th, td,\narticle, aside, canvas, details, embed,\nfigure, figcaption, footer, header, hgroup,\nmenu, nav, output, ruby, section, summary,\ntime, mark, audio, video {\n\tmargin: 0;\n\tpadding: 0;\n\tborder: 0;\n\tfont-size: 100%;\n\tfont: inherit;\n\tvertical-align: baseline;\n}\n/* HTML5 display-role reset for older browsers *\narticle, aside, details, figcaption, figure,\nfooter, header, hgroup, menu, nav, section {\n\tdisplay: block;\n}\nbody {\n\tline-height: 1;\n}\nol, ul {\n\tlist-style: none;\n}\nblockquote, q {\n\tquotes: none;\n}\nblockquote:before, blockquote:after,\nq:before, q:after {\n\tcontent: '';\n\tcontent: none;\n}\ntable {\n\tborder-collapse: collapse;\n\tborder-spacing: 0;\n}\nul {\n    list-style-type: none;\n} */\n\n\n\n\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
const handleSubmit = async (event) => {
    ...
    if ((0,_nameChecker__WEBPACK_IMPORTED_MODULE_0__.validateURL)(input.value)){
        show_error("please, enter a valid url")
        
    }
    const {data} = await axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('http://localhost:8000', form, {
        headers: {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   handleSubmit: () => (/* reexport safe */ _js_formHandler__WEBPACK_IMPORTED_MODULE_0__.handleSubmit)
/* harmony export */ });
